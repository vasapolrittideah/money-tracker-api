...
helm_resource(
    ...
    "bitnami/mongodb",
    flags = [
        "--values=./infra/helm/values/dev/auth-mongodb-values.yaml",
        "--values=./infra/helm/values/dev/auth-mongodb-secrets.yaml",
    ],
    resource_deps = ["bitnami"],
)
k8s_resource("auth-mongodb", port_forwards = ["27017:27017"], labels = "databases")

deploy_service(
    "auth-service",
    resource_deps = ["auth-mongodb", "consul"],
    values_files = [
